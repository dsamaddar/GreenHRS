<%@ Page Language="VB" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmConfirmationDue.aspx.vb" Inherits="Services_frmConfirmationDue"
    Title=".:HRM:Confirmation Due:." %>
                        ...
                        <tr align="left">
                            <td>
                                <div style="max-width: 100%; max-height: 400px; overflow: scroll">
                                    <asp:GridView ID="grdConfirmationDue" runat="server" AutoGenerateColumns="False"
                                        CssClass="mGrid">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Confirmation Due Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("ConfirmationDate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
