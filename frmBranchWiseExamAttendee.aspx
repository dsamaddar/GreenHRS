<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmBranchWiseExamAttendee.aspx.vb" Inherits="frmBranchWiseExamAttendee"
    Title=".:HRM:Branch Wise Exam Attendee:." %>
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="reqFldStartDate" runat="server" ControlToValidate="txtStartDate"
                                    Display="None" ErrorMessage="Required: Start Date" ValidationGroup="ExamAttendee"></asp:RequiredFieldValidator>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="reqFldEndDate" runat="server" ControlToValidate="txtEndDate"
                                    Display="None" ErrorMessage="Required:End Date" ValidationGroup="ExamAttendee"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:GridView ID="grdExamAttendeeReport" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText=" CV Details " ShowHeader="False">
                                                <ItemTemplate>
                                                    <span style="display: block"><a href='<%#"RecuitmentCVView.aspx?CandidateID="+ Eval("ExamTakerID")+""  %>'
