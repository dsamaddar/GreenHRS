...
Partial Class InterviewPanel_frmPrimaryInterviewPanel
    ...
    Protected Sub ClearIntAssessmentForm()
        ...
        btnAcceptCandidate.Enabled = False
    End Sub
    ...
    Protected Sub GetAvailableIntCandidats()
        ...
        grdInterviewCandidate.DataSource = IntCandidateData.fnGetIntCandidatesByIntTakerPrimary(EmployeeID)
    ...
    Protected Sub grdInterviewCandidate_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdInterviewCandidate.SelectedIndexChanged
        ...
        btnAcceptCandidate.Enabled = True
    ...
    Protected Sub btnCancelSelection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancelSelection.Click
        ...
        Response.Redirect("frmPrimaryInterviewPanel.aspx")
    End Sub
    ...
    Protected Sub btnAcceptCandidate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAcceptCandidate.Click
        Dim lblIntManQuestionID As New Label()
        Dim chkIntManQuestion As New CheckBox()
        Dim txtQuesAnswer As New TextBox()
    ...
    Protected Sub AssignInterview()

        Dim IntCandidate As New clsInterviewCandidate()
        Dim lblCandidateID As New Label()
        lblCandidateID = grdInterviewCandidate.SelectedRow.FindControl("lblCandidateID")

        IntCandidate.Participant = lblCandidateID.Text
        IntCandidate.CircularID = "N\A" ' drpAvailableCircular.SelectedValue
        IntCandidate.IntTeamID = drpAvailableIntTeamList.SelectedValue
        IntCandidate.InterviewDate = Convert.ToDateTime(txtInterviewDate.Text & " " & drpHour.SelectedValue & ":" & drpMin.SelectedValue & ":00" & " " & drpAMPM.SelectedValue)
        IntCandidate.EntryBy = Session("LoginUserID")

        Dim check As Integer = IntCandidateData.fnAssignCandidateToIntPanel(IntCandidate)

        If check <> 1 Then
            MessageBox("Error Found While Assigning Interviwe")
        End If
