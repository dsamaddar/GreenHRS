<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmInterviewPanelNew.aspx.vb" Inherits="InterviewPanel_frmInterviewPanelNew"
                ...
                <asp:Panel ID="pnlFinalAssessment" runat="server" SkinID="pnlInner">
                    <table style="width: 100%;">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:Button ID="btnMakeAssessment" runat="server" CssClass="styled-button-1" OnClientClick="if (!confirm('Are you Sure to Make Assessment ?')) return false"
                                    Text="POOL" ValidationGroup="ApplicantAssessment" />
