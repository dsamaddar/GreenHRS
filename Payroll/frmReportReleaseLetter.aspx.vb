...
Partial Class Payroll_frmReportReleaseLetter
    ...
    Protected Sub btnProcessReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcessReport.Click
        ...
        Try
            ...
            repName = folder & "rptReleaseLetter.rpt"
            ...
            myReport.SetParameterValue("@ResignationLetterDate", txtResignationLetterDate.Text)
            myReport.SetParameterValue("@ResignationEffectiveDate", txtResignationEffectiveDate.Text)
