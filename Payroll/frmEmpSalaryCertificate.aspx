<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmEmpSalaryCertificate.aspx.vb" Inherits="Payroll_frmEmpSalaryCertificate"
    Title=".:HRM:Emp. Salary Certificate:." %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%;">
        <tr align="center">
            ...
            <td>
                <asp:Panel ID="pnlEmpWiseSalaryCertificate" runat="server" Width="60%" 
                    SkinID="pnlInner">
                    <table style="width: 100%;">
                        <tr align="left">
                            <td colspan="4">
                                <div class="widget-title">
                                    Salary Certificate</div>
                            </td>
                        </tr>
                        <tr align="left">
                            <td>
