...
Partial Class Payroll_frmReportNOCForPassport
    ...
    Protected Sub btnNOCForPassport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNOCForPassport.Click
        ...
        Try
            ...
            repName = folder & "rptNOCForPassport.rpt"
