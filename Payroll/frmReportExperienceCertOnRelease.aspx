<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmReportExperienceCertOnRelease.aspx.vb" Inherits="Payroll_frmReportExperienceCertOnRelease"
    Title=".:HRM:Experience Certificate On Release:." %>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="label">
                                            Resignation Date</td>
                                        <td>
                                            <asp:TextBox ID="txtResignationDate" runat="server" CssClass="InputTxtBox" 
                                                Width="120px"></asp:TextBox>
                                            <cc1:CalendarExtender ID="txtResignationDate_CalendarExtender" runat="server" 
                                                Enabled="True" TargetControlID="txtResignationDate">
                                            </cc1:CalendarExtender>
                                        </td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldResignationDate" runat="server" 
                                                ControlToValidate="txtResignationDate" Display="None" 
                                                ErrorMessage="Required : Resignation Date" ValidationGroup="GenerateReport"></asp:RequiredFieldValidator>
                                            <cc1:ValidatorCalloutExtender ID="reqFldResignationDate_ValidatorCalloutExtender" 
                                                runat="server" CloseImageUrl="~/Sources/images/valClose.png" 
                                                CssClass="customCalloutStyle" Enabled="True" 
                                                TargetControlID="reqFldResignationDate" 
