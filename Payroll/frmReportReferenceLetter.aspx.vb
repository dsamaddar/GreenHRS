...
Partial Class Payroll_frmReportReferenceLetter
    ...
    Protected Sub btnProcessReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcessReport.Click
        ...
        Try
            ...
            repName = folder & "rptReferenceLetter.rpt"
            ...
            myReport.SetParameterValue("@AddressingPerson", txtAddressingPerson.Text)
            myReport.SetParameterValue("@Designation", txtDesignation.Text)
            myReport.SetParameterValue("@Address_01", txtAddress_01.Text)
            myReport.SetParameterValue("@Address_02", txtAddress_02.Text)
            myReport.SetParameterValue("@Address_03", txtAddress_03.Text)
