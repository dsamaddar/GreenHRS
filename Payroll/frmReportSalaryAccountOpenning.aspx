<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmReportSalaryAccountOpenning.aspx.vb" Inherits="Payroll_frmReportSalaryAccountOpenning"
    Title=".:HRM:Salary Account Openning:." %>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="label">
                                            Appointmetn Date</td>
                                        <td>
                                            <asp:TextBox ID="txtAppointmentDate" runat="server" CssClass="InputTxtBox" 
                                                Width="120px"></asp:TextBox>
                                            <cc1:CalendarExtender ID="txtAppointmentDate_CalendarExtender" runat="server" 
                                                Enabled="True" TargetControlID="txtAppointmentDate">
