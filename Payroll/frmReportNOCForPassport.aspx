<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmReportNOCForPassport.aspx.vb" Inherits="Payroll_frmReportNOCForPassport"
    Title=".:HRM:NOC For Passport:." %>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="label">
                                            &nbsp;</td>
                                        <td>
                                            <asp:Button ID="btnNOCForPassport" runat="server" CssClass="styled-button-1" 
                                                Text="NOC For Passport" />
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
