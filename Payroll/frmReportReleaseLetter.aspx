<%@ Page Language="VB" Theme="CommonSkin"  MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmReportReleaseLetter.aspx.vb" Inherits="Payroll_frmReportReleaseLetter"
    Title=".:HRM:Release Letter:." %>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <cc1:ValidatorCalloutExtender ID="reqFldRefNo_ValidatorCalloutExtender1" runat="server"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtResignationLetterDate" runat="server" CssClass="InputTxtBox"
                                                Width="120px"></asp:TextBox>
                                            <cc1:CalendarExtender ID="txtResignationLetterDate_CalendarExtender" runat="server"
                                                Enabled="True" TargetControlID="txtResignationLetterDate">
                                            </cc1:CalendarExtender>
                                        </td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldResignationLetterDate" runat="server" ControlToValidate="txtResignationLetterDate"
                                                Display="None" ErrorMessage="Required : Resignation Letter Date" ValidationGroup="GenerateReport"></asp:RequiredFieldValidator>
                                            <cc1:ValidatorCalloutExtender ID="reqFldResignationLetterDate_ValidatorCalloutExtender"
                                                runat="server" CloseImageUrl="~/Sources/images/valClose.png" CssClass="customCalloutStyle"
                                                Enabled="True" TargetControlID="reqFldResignationLetterDate" WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                            </cc1:ValidatorCalloutExtender>
                                            <asp:CompareValidator ID="cmpValResignationLetterDate" runat="server" ControlToValidate="txtResignationLetterDate"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtResignationEffectiveDate" runat="server" CssClass="InputTxtBox"
                                                Width="120px"></asp:TextBox>
                                            <cc1:CalendarExtender ID="txtResignationEffectiveDate_CalendarExtender" runat="server"
                                                Enabled="True" TargetControlID="txtResignationEffectiveDate">
                                            </cc1:CalendarExtender>
                                        </td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldResignationEffectiveDate" runat="server" ControlToValidate="txtResignationEffectiveDate"
                                                Display="None" ErrorMessage="Required : Resignation Effective Date" ValidationGroup="GenerateReport"></asp:RequiredFieldValidator>
                                            <asp:CompareValidator ID="cmpValResignationEffectiveDate" runat="server" ControlToValidate="txtResignationEffectiveDate"
                                                ErrorMessage="Invalid Date" Operator="DataTypeCheck" Type="Date" ValidationGroup="GenerateReport"></asp:CompareValidator>
                                            <cc1:ValidatorCalloutExtender ID="reqFldResignationEffectiveDate_ValidatorCalloutExtender"
                                                runat="server" CloseImageUrl="~/Sources/images/valClose.png" CssClass="customCalloutStyle"
                                                Enabled="True" TargetControlID="reqFldResignationEffectiveDate" WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                            </cc1:ValidatorCalloutExtender>
                                        </td>
                                    </tr>
                                    <tr>
