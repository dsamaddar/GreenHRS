...
Partial Class Payroll_frmReportExperienceCertOnRelease
    ...
    Protected Sub btnProcessReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcessReport.Click
        ...
        Try
            ...
            repName = folder & "rptExperienceCertOnRelease.rpt"
            ...
            myReport.SetParameterValue("@ResignationDate", Convert.ToDateTime(txtEffectiveDate.Text))
