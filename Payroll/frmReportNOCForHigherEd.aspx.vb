...
Partial Class Payroll_frmReportNOCForHigherEd
    ...
    Protected Sub btnProcessReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcessReport.Click
        ...
        Try
            ...
            repName = folder & "rptNOCForHigherEdu.rpt"
            ...
            myReport.ExportToHttpResponse(ExportFormatType.RichText, Response, True, "NOC-Higher-Edu")
