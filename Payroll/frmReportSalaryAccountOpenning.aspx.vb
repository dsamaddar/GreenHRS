...
Partial Class Payroll_frmReportSalaryAccountOpenning
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            ShowDepertment()
            ShowMedicalOffList()
            txtAppointmentRefNo.Text = "N\A"
            txtAppointmentDate.Text = Now.Date
        End If
    End Sub
    ...
    Protected Sub btnProcessReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcessReport.Click
        ...
        Try
            ...
            repName = folder & "rptOpenningSalaryAccount.rpt"
