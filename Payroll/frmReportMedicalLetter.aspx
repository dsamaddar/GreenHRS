<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmReportMedicalLetter.aspx.vb" Inherits="Payroll_frmReportMedicalLetter"
    Title=".:HRM:Medical Letter:." %>
                            ...
                            <td>
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldRefNo" runat="server" ControlToValidate="txtReferenceNo"
                                                Display="None" ErrorMessage="Required : Ref. No" 
                                    ...
                                    <tr>
                                        ...
                                        <td class="label">
                                            Appointment Ref. No</td>
                                        <td>
                                            <asp:TextBox ID="txtAppointmentRefNo" runat="server" CssClass="InputTxtBox" 
                                                Width="200px"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldAppointmentRefNo" runat="server" 
                                                ControlToValidate="txtAppointmentRefNo" Display="None" 
                                                ErrorMessage="Required : Appointment Ref No" ValidationGroup="GenerateReport"></asp:RequiredFieldValidator>
                                            <cc1:ValidatorCalloutExtender ID="reqFldAppointmentRefNo_ValidatorCalloutExtender" 
                                                ...
                                                TargetControlID="reqFldAppointmentRefNo" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnProcessMedToEmp" runat="server" CssClass="styled-button-1" 
                                                Text="Med. To Emp" ValidationGroup="GenerateReport" />
                                        </td>
                                        <td>
                                            &nbsp;<asp:Button ID="btnProcessMedToDoc" runat="server" CssClass="styled-button-1"
                                                Text="Med. To Doc" ValidationGroup="GenerateReport" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
