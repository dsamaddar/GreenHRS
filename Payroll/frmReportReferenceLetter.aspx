<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmReportReferenceLetter.aspx.vb" Inherits="Payroll_frmReportReferenceLetter"
    Title=".:HRM:Reference Letter:." %>
                            ...
                            <td>
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldAddressingPerson" runat="server" ControlToValidate="txtAddressingPerson"
                                                Display="None" ErrorMessage="Required : Addressing Person" ValidationGroup="GenerateReport"></asp:RequiredFieldValidator>
                                            <cc1:ValidatorCalloutExtender ID="reqFldAddressingPerson_ValidatorCalloutExtender"
                                                ...
                                                Enabled="True" TargetControlID="reqFldAddressingPerson" WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                            </cc1:ValidatorCalloutExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldDesignation" runat="server" ControlToValidate="txtDesignation"
                                                Display="None" ErrorMessage="Required : Designation" ValidationGroup="GenerateReport"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAddress_01" runat="server" CssClass="InputTxtBox" Width="200px"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldAddressLine" runat="server" ControlToValidate="txtAddress_01"
                                                Display="None" ErrorMessage="Required : Address" ValidationGroup="GenerateReport"></asp:RequiredFieldValidator>
                                            <cc1:ValidatorCalloutExtender ID="reqFldAddressLine_ValidatorCalloutExtender" runat="server"
                                                CloseImageUrl="~/Sources/images/valClose.png" CssClass="customCalloutStyle" Enabled="True"
                                                TargetControlID="reqFldAddressLine" WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                            </cc1:ValidatorCalloutExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAddress_02" runat="server" CssClass="InputTxtBox" Width="200px"></asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAddress_03" runat="server" CssClass="InputTxtBox" Width="200px"></asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
