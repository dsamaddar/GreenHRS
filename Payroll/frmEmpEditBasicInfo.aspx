<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmEmpEditBasicInfo.aspx.vb" Inherits="Payroll_frmEmpEditBasicInfo"
                                ...
                                <asp:Panel ID="pnlEmpBasicInfo" runat="server" SkinID="pnlInner">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtBasicSalary" runat="server" CssClass="InputTxtBox" Width="120px"></asp:TextBox>
                                                &nbsp;
                                                <asp:RequiredFieldValidator ID="reqFldEmpBasicSalary" runat="server" ControlToValidate="txtBasicSalary"
                                                    Display="None" ErrorMessage="Required : Basic Salary" ValidationGroup="UpdateEmp"></asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="reqFldEmpBasicSalary_ValidatorCalloutExtender"
                                                    runat="server" CloseImageUrl="~/Sources/images/valClose.png" CssClass="customCalloutStyle"
                                                    Enabled="True" TargetControlID="reqFldEmpBasicSalary" WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                                </cc1:ValidatorCalloutExtender>
                                            </td>
                                            <td class="label">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                &nbsp;
                                                <asp:RequiredFieldValidator ID="reqFldEmpUserID" runat="server" ControlToValidate="txtUserID"
                                                    Display="None" ErrorMessage="Required : User ID" ValidationGroup="UpdateEmp"></asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="reqFldEmpUserID_ValidatorCalloutExtender" runat="server"
                                                    CloseImageUrl="~/Sources/images/valClose.png" CssClass="customCalloutStyle" Enabled="True"
                                                    TargetControlID="reqFldEmpUserID" WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                                </cc1:ValidatorCalloutExtender>
                                            </td>
                                            <td class="label">
                                                Attendance ID
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtUserPassword" runat="server" CssClass="InputTxtBox" Width="120px"
                                                    TextMode="Password"></asp:TextBox>
                                                &nbsp;&nbsp;<asp:RequiredFieldValidator ID="reqFldEmpPassword" runat="server" ControlToValidate="txtUserPassword"
                                                    Display="None" ErrorMessage="Required : Password" ValidationGroup="UpdateEmp"></asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="reqFldEmpPassword_ValidatorCalloutExtender" runat="server"
                                                    CloseImageUrl="~/Sources/images/valClose.png" CssClass="customCalloutStyle" Enabled="True"
                                                    TargetControlID="reqFldEmpPassword" WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                                </cc1:ValidatorCalloutExtender>
                                            </td>
                                            <td class="label">
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="reqFldProbationEffectiveDate" runat="server" ControlToValidate="txtProbationEffectiveDate"
                                                    ErrorMessage="Probation Effective Date" ValidationGroup="UpdateEmp" Display="None">
                                                </asp:RequiredFieldValidator><cc1:ValidatorCalloutExtender ID="reqFldProbationEffectiveDate_ValidatorCalloutExtender"
                                                    runat="server" Enabled="True" TargetControlID="reqFldProbationEffectiveDate"
