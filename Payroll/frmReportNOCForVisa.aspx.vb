...
Partial Class Payroll_frmReportNOCForVisa
    ...
    Protected Sub btnProcessReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcessReport.Click
        ...
        If drpCountry.SelectedValue = "N\A" Then
            MessageBox("Select Country")
            Exit Sub
        End If

        If Convert.ToDateTime(txtDepartureDate.Text) > Convert.ToDateTime(txtArrivalDate.Text) Then
            Dim A As DateTime = Convert.ToDateTime(txtDepartureDate.Text)
            txtDepartureDate.Text = txtArrivalDate.Text
            txtArrivalDate.Text = A.ToString()
        End If
        ...
        Try
            ...
            repName = folder & "rptNOCForVisa.rpt"
            ...
            myReport.SetParameterValue("@Counrtry", drpCountry.SelectedValue)
            myReport.SetParameterValue("@DepartureDate", txtDepartureDate.Text)
            myReport.SetParameterValue("@ArrivalDate", txtArrivalDate.Text)
