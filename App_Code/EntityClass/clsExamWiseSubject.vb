...
Public Class clsExamWiseSubject

    Dim _ExamWiseSubjectID, _ExamID, _SubjectID, _SubjectName, _EntryBy, _DifficultyLevel As String
    ...
    Public Property DifficultyLevel() As String
        Get
    ...
    Dim _PositiveMarkingPerQuestion, _NegativeMarkingPerQuestion, _SkipMarkingPerQuestion, _NotAnsweredMarkingPerQuestion, _QuePickPercentage, _AllocatedQuestion As Double
    ...
    Public Property AllocatedQuestion() As Double
        Get
