...
Public Class CanEduInfo
    Dim _ExamName, _Major, _MajorID, _ExamID, _InstitutionID, _InstitutionName, _ResultType, _Result, _OtherInstitutionName, _DegreeType As String
