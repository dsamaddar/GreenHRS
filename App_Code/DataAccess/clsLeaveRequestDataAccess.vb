...
Public Class clsLeaveRequestDataAccess
    ...
    Public Function ChangeApplicationStatus(ByVal LeaveRequestID As String, ByVal TakenAction As String, ByVal ApproverID As String, ByVal Remarks As String) As Integer
