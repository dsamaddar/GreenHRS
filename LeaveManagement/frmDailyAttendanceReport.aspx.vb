...
Partial Class LeaveManagement_frmDailyAttendanceReport
    ...
    Protected Sub ShowDailyAttendanceReport(ByVal AttDate As DateTime)
        grdAttReport.DataSource = UserAttData.fnGetDailyAttReport(AttDate)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If InStr(MenuIDs, "DailyAttReport~") = 0 Then
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            repName = folder & "DailyAttendanceReport.rpt"
    ...
    Protected Sub btnSyncOLDAttSystem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSyncOLDAttSystem.Click
        Dim Check As Integer = UserAttData.fnInsertUsrAttInfoOLDSystem()

        If Check = 1 Then
            MessageBox("Sync. Done")
        Else
            MessageBox("Error Found While Sync.")
        End If
    End Sub
