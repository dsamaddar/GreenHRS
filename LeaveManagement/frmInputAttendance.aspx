<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmInputAttendance.aspx.vb" Inherits="LeaveManagement_frmInputAttendance"
    Title=".:HRM:Manual Att Input:." %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%;">
        <tr align="center">
            ...
            <td>
                <asp:Panel ID="pnlEmpInputAttendance" runat="server" SkinID="pnlInner" Width="800px">
                    <table style="width: 100%;">
                        <tr align="left">
                            <td colspan="5">
                        ...
                        <tr align="left">
                            ...
                            <td class="label">
                                <asp:TextBox ID="txtAttendanceDate" runat="server" CssClass="InputTxtBox" Width="120px"
                        ...
                        <tr align="left">
                            ...
                            <td class="label">
                                <asp:TextBox ID="txtAttendanceDateTo" runat="server" AutoPostBack="True" 
                                    CssClass="InputTxtBox" Width="120px"></asp:TextBox>
                                <cc1:CalendarExtender ID="txtAttendanceDateTo_CalendarExtender" runat="server" 
                                    Enabled="True" TargetControlID="txtAttendanceDateTo">
                                </cc1:CalendarExtender>
                            </td>
                            <td class="label">
                                <asp:RequiredFieldValidator ID="reqFldAttendanceDateTo" runat="server" 
                                    ControlToValidate="txtAttendanceDateTo" Display="None" ErrorMessage="" 
                                ...
                                <cc1:ValidatorCalloutExtender ID="reqFldAttendanceDateTo_ValidatorCalloutExtender" 
                                    ...
                                    TargetControlID="reqFldAttendanceDateTo" 
                                    WarningIconImageUrl="~/Sources/images/Valwarning.png">
                                </cc1:ValidatorCalloutExtender>
                            </td>
                            <td class="label">
                                <asp:CompareValidator ID="dateValidateAttendanceDateTo" runat="server" 
                                    ControlToValidate="txtAttendanceDateTo" ErrorMessage="Invalid Date" 
                                    Operator="DataTypeCheck" Type="Date" ValidationGroup="InputAtt"></asp:CompareValidator>
                            </td>
                        </tr>
                        <tr align="left">
                            <td>
