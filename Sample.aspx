<%@ Page Language="VB" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false" CodeFile="Sample.aspx.vb" Inherits="Sample" title="Untitled Page" %>
    ...
    <div id="content" class="clearfix">
        ...
        <div id="main">
      		    ...
      		    <div class="primary">
                    ...
                    <p class="post-info"><span>filed under</span> <a href="index.html">templates</a>, <a href="index.html">internet</a></p>
               	    ...
               	    <div class="image-section">
              		    <img src="Sources/images/img-post.jpg" alt="image post" height="206" width="498"/>
         	        </div>
            ...
            <article class="post">
         	    ...
         	    <div class="primary">
            	    ...
            	    <h2><a href="index.html">Lorem Tellus Eleifend Magna</a></h2>
		...
		<div id="sidebar">
      	    ...
      	    <div class="about-me">
                ...
                <p>
		        <a href="index.html"><img src="Sources/images/gravatar.jpg" width="42" height="42" alt="firefox" class="align-left" /></a>
