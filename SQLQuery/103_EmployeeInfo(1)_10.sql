...
CREATE proc [dbo].[spInsertHealthPlan]
...
begin tran
	...
	INSERT INTO [tblHealthPlan]
           ([HealthPlanID] ,[HealthPlanName] ,[PremiumPercentage],[IsActive],[EntryBy])
     VALUES
           (@HealthPlanID,@HealthPlanName,@PremiumPercentage,@IsActive,@EntryBy)
...
exec spInsertHealthPlan 'Basic',5,'1','tahmed1'
exec spInsertHealthPlan 'Standard',5,'1','tahmed1'
exec spInsertHealthPlan 'Executive',5,'1','tahmed1'
exec spInsertHealthPlan 'Premier',5,'1','tahmed1'
...
CREATE TABLE [dbo].[tblDesignation](
	...
	[DesignationLabel] [nvarchar](100) NULL,
	[DesignationType] [nvarchar](200) NOT NULL,
	[HealthPlanID] [nvarchar](50) NULL,
	[intOrder] [int] NULL,
	[isActive] [bit] NULL,
	[EntryBy] [nvarchar](50) NULL,
	[EntryDate] [datetime] NULL,
...
(
 ...
 CONSTRAINT [UQ__tblDesig__372CDC23436BFEE3] UNIQUE NONCLUSTERED 
(
	[DesignationName] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[tblDesignation]  WITH CHECK ADD  CONSTRAINT [FK_tblDesignation_tblHealthPlan] FOREIGN KEY([HealthPlanID])
REFERENCES [dbo].[tblHealthPlan] ([HealthPlanID])
GO

ALTER TABLE [dbo].[tblDesignation] CHECK CONSTRAINT [FK_tblDesignation_tblHealthPlan]
GO
...
CREATE proc [dbo].[spGetDesignation]
as
begin
...
exec  spInsertEmployeeInformation '',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,1,null ,null,null,null,null
