--drop table [tblCandidateBasicInfo]
...
ALTER TABLE [dbo].[tblCandidateBasicInfo] ADD  CONSTRAINT [DF_tblCandidateBasicInfo_IsRejected]  DEFAULT ((0)) FOR [IsRejected]
GO
...
--drop procedure spInsertCandidateBasicInfo
...
--drop proc prGetCandidateBasicInfo
...
--exec prGetCandidateBasicInfo 'test1'
  ...
  where [tblCandidateBasicInfo].RegistrationID=@RegistrationID
...
--drop proc spCandidateExperirnce
...
begin
 ...
 --drop table tblCandidateSpecilization
...
--drop proc [spInsertCanSpecilizedInfo]
