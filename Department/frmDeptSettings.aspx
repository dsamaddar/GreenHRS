<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="frmDeptSettings.aspx.vb" Inherits="Department_frmDeptSettings" Title=".:HRM:Dept. Settings:." %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%;">
        <tr align="center">
            ...
            <td>
                <asp:Panel ID="pnlDepartmentSettings" runat="server" Width="600px" SkinID="pnlInner">
                    <table style="width: 100%;">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:Button ID="btnInsertDepartment" runat="server" CssClass="styled-button-1" Text="Insert"
                                    ValidationGroup="InputDept" />
                        ...
                        <tr>
                            ...
                            <td align="left" class="label">
                                <b>Available Department</b>
                            </td>
                            <td align="left">
                                <asp:DropDownList ID="drpAvailableDepartment" runat="server" CssClass="InputTxtBox"
                                    Width="200px">
                                </asp:DropDownList>
                            </td>
                            <td>
        ...
        <tr align="center">
            ...
            <td>
                <asp:Panel ID="pnlExistingDepartment" runat="server" Width="600px" SkinID="pnlInner">
