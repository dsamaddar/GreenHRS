<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/EmployeeProfile/MasterEmpProfile.master"
    AutoEventWireup="false" CodeFile="frmEmpWiseSalaryInd.aspx.vb" Inherits="EmployeeProfile_frmEmpWiseSalaryInd"
    Title=":HRM:Employee Wise Salary Info:." %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%;">
        <tr>
            <td>
                <asp:Panel ID="pnlTaxCertificate" runat="server" SkinID="pnlInner">
                    <table style="width: 100%;">
                        <tr>
                            <td colspan="5">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnTaxCertificate" runat="server" BackColor="Blue" ForeColor="White"
        ...
        <tr align="center">
            <td>
                <asp:Panel ID="pnlSalaryParameters" runat="server" SkinID="pnlInner" Width="100%">
                    <table style="width: 100%;">
                        <tr align="left">
                            <td colspan="6">
                                <div class="widget-title">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:Button ID="btnExportSalaryCertificate" runat="server" BackColor="#009933" 
                                    ForeColor="White" Text="Export Salary Certificate" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
        ...
        <tr align="center">
            <td>
                <asp:Panel ID="pnlSalSummary" runat="server" SkinID="pnlInner" Width="100%">
                    <table style="width: 100%;">
                        <tr align="left">
                            <td>
                            </td>
        ...
        <tr align="center">
            <td>
                <asp:Panel ID="pnlSalaryComponents" runat="server" SkinID="pnlInner" Width="100%">
                    <table style="width: 100%;">
                        <tr align="left">
        ...
        <tr align="center">
            <td align="center">
                <asp:Panel ID="pnlTaxAdvanceAdjustment" runat="server" Width="100%" SkinID="pnlInner">
                                ...
                                <asp:TemplateField HeaderText="Adjustment History">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbtnResponseCount" runat="server" CausesValidation="False"
                                            CssClass="linkbtn" Font-Size="14px" OnClientClick='<%# Eval("TaxAdvanceID","openWindow(""../Payroll/frmTaxAdvAdjHistory.aspx?TaxAdvanceID={0}"",""Popup"",800,800);") %>'
        ...
        <tr align="center">
            <td align="center">
                <asp:Panel ID="pnlTaxDeductionDetails" runat="server" Width="100%" SkinID="pnlInner">
                    <table width="100%">
                        <tr align="left">
                            <td colspan="2">
                                <div class="widget-title">
