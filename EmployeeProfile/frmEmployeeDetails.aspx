<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/EmployeeProfile/MasterEmpProfile.master"
    ...
    Title=".:HRM:Employee Summary:." MaintainScrollPositionOnPostback="true" %>
                ...
                <asp:Panel ID="pnlContactInformation" runat="server" SkinID="pnlInner">
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPreAdd" runat="server" AutoPostBack="True" CssClass="InputTxtBox"
                                    Height="45px" TabIndex="25" TextMode="MultiLine" Width="200px"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="txtPerAddress" runat="server" AutoPostBack="true" CssClass="InputTxtBox"
                                    Height="45px" TabIndex="28" TextMode="MultiLine" Width="200px"></asp:TextBox>
