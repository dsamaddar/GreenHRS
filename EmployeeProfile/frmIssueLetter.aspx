<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/EmployeeProfile/MasterEmpProfile.master"
    AutoEventWireup="false" CodeFile="frmIssueLetter.aspx.vb" Inherits="EmployeeProfile_frmIssueLetter"
    Title=".:HRM:Issue Letter:." %>
                ...
                <asp:Panel ID="pnlUploadLetters" runat="server" Width="100%" SkinID="pnlInner">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtIssueDate" runat="server" CssClass="InputTxtBox" Width="200px"
                        ...
                        <asp:GridView ID="grdIssuedLetters" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="View" ShowHeader="true">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hpDocument" runat="server" CssClass="linkbtn" NavigateUrl='<%# ConfigurationManager.AppSettings("AttachmentsShow")+ Eval("DocumentName") %>'
                                            Target="_blank">View</asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Delete" ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnDelete" ImageUrl="~/Sources/icons/erase.png" OnClientClick="if (!confirm('Are you Sure to Delete The Document ?')) return false"
