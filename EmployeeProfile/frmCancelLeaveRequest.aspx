<%@ Page Language="VB" Theme="CommonSkin"  MasterPageFile="~/EmployeeProfile/MasterEmpProfile.master" AutoEventWireup="false" CodeFile="frmCancelLeaveRequest.aspx.vb" Inherits="EmployeeProfile_frmCancelLeaveRequest" title="Untitled Page" %>
                                ...
                                <table width="100%">
                                    <tr align="left" >
                                        ...
                                        <td class="label" style="width:200px">
                                            &nbsp;Remarks For Cancellation</td>
                                        <td style="width:250px">
                                            <asp:TextBox ID="txtCancellationRemarks" runat="server" TextMode="MultiLine" 
                                                Width="250px" CssClass="InputTxtBox" Height="50px">N\A</asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="reqFldCancellationRemarks" runat="server" 
                                                ControlToValidate="txtCancellationRemarks" Display="None" 
                                                ErrorMessage="Required: Leave Cancellation Remarks" 
                                                ValidationGroup="LeaveCancellation"></asp:RequiredFieldValidator>
                                            <cc1:ValidatorCalloutExtender ID="reqFldCancellationRemarks_ValidatorCalloutExtender" 
                                                ...
                                                TargetControlID="reqFldCancellationRemarks" 
                                    ...
                                    <tr align="left">
                                        ...
                                        <td class="label" style="width:200px">
                                            &nbsp;</td>
                                        <td style="width:250px">
                                            <asp:Button ID="btnLeaveReqReject" runat="server" CssClass="styled-button-1" 
