<%@ Page Language="VB" MasterPageFile="~/EmployeeProfile/MasterEmpProfile.master"
    AutoEventWireup="false" CodeFile="frmEmpEduProInfo.aspx.vb" Inherits="EmployeeProfile_frmEmpEduProInfo"
    Title="::Employee Education & Professional Certification::" Theme="CommonSkin" %>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td align="Left" style="width: 790px;">
                <div class="widgettitle">Professional Certification</div>
        ...
        <tr>
            ...
            <td align="center">
                <asp:Panel ID="pnlAnyProfCertification" runat="server" SkinID="pnlInner" 
                    Width="100%">
                    <table style="width: 100%;">
                        <tr align="left">
                            <td style="width: 20px">
                            ...
                            <td align="left" style="width:200px" class="label" >
                                Any professional certification ?</td>
                            <td align="left">
                                <asp:RadioButtonList ID="rdbtnIsProfessionalCertificationExists" runat="server" 
            ...
            <td>
                <asp:Panel ID="pnlCertification" runat="server" Width="800px" SkinID="pnlInner">
                    <div style="max-height: 200px; max-width: 100%; overflow: auto">
                        <asp:GridView ID="grdCertification" runat="server" AutoGenerateColumns="False" 
        ...
        <tr align="center">
            ...
            <td align="left" style="width: 790px;">
                <div class="widgettitle">Educational Qualification</div>
            </td>
            <td>
            </td>
        </tr>
                ...
                <asp:Panel ID="pnlEduInfo" runat="server" SkinID="pnlInner" Width="800px">
                    <table style="width: 100%;">
                        <tr>
                            <td align="left" class="label" style="width: 20px">
                                &nbsp;</td>
                            <td align="left" class="label" colspan="2" style="color: Green;">
                        ...
                        <asp:GridView ID="grdEducation" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Degree Type">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox7" runat="server" Text='<%# Eval("DegreeType") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Degree Name">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox8" runat="server" Text='<%# Eval("ExamName") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Major ID" Visible="False">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("MajorID") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Major">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox10" runat="server" Text='<%# Eval("Major") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="InstitutionID" Visible="False">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox11" runat="server" Text='<%# Bind("InstitutionID") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Institutaion">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox12" runat="server" Text='<%# Eval("InstitutionName") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Passing Year">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox13" runat="server" Text='<%# Eval("PassingYear") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Result Type">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox14" runat="server" Text='<%# Eval("ResultType") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Result">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox15" runat="server" Text='<%# Eval("Result") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Out Of">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox16" runat="server" Text='<%# Eval("OutOf") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <asp:ImageButton Width="40" ID="imgDelete0" CommandName="Delete" runat="server" OnClientClick="return confirm('Are You Sure You Want to Delete?')"
                                            ImageUrl="~/img/delete.jpg" CausesValidation="False" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
        ...
        <tr align="center">
            ...
            <td>
                <asp:Panel ID="pnlEduQuaSave" runat="server" SkinID="pnlInner" Width="800px">
