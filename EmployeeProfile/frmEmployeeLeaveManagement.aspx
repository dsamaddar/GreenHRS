                                    ...
                                    <asp:GridView ID="grdRecommendedLeave" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="LeaveRequestID" Visible="False">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtLeaveRequestID0" runat="server" Text='<%# Bind("LeaveRequestID") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                    ...
                                    <div style="max-height: 100%; max-width: 100%; overflow: auto;">
                                        <asp:GridView ID="grdLeaveApproval" runat="server" AutoGenerateColumns="False" CellPadding="0"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="LeaveRequestID" Visible="False">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtLeaveRequestID" runat="server" Text='<%# Bind("LeaveRequestID") %>'></asp:TextBox></EditItemTemplate>
                                                    <ItemTemplate>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td width="150px" align="left">
                                                <asp:Label ID="lblTotalLeave" runat="server" Font-Size="12pt" Font-Bold="True" ForeColor="Black"
                                                    Font-Names="verdana" Text="Total Leave: "></asp:Label><asp:Label ID="lblTLeveCnt"
                                                        runat="server" Font-Size="12pt" ForeColor="Black" Font-Names="verdana" Font-Bold="True"></asp:Label>
                                            </td>
                                            <td width="40%" align="left">
                                                <asp:Label ID="lblLeaveTaken" runat="server" Font-Size="12pt" ForeColor="Black" Font-Names="verdana"
                                                    Text="Leave Taken: " Font-Bold="True"></asp:Label><asp:Label ID="lblLeveTknCnt" runat="server"
                                                        Font-Size="12pt" ForeColor="Black" Font-Names="verdana" Font-Bold="True"></asp:Label>
                                            </td>
                                            <td width="30%" align="left">
                                                <asp:Label ID="lblLeaveBalance" runat="server" Font-Size="12pt" ForeColor="Black"
                                                    Font-Names="verdana" Text="Leave Balance: " Font-Bold="True"></asp:Label><asp:Label
                                                        ID="lblBlceCnt" runat="server" Font-Size="12pt" ForeColor="Black" Font-Names="verdana"
                                ...
                                <asp:Panel ID="pnlLeaveReq" runat="server" SkinID="pnlInner">
                                    <table align="center">
                                        <tr align="center">
                                            ...
                                            <td align="center">
                                                <asp:Panel ID="pnlCalculationDay" runat="server" Width="100%" SkinID="pnlInner">
                                                    <div style="max-height: 200px; max-width: 100%; overflow: auto;" align="center">
                                                        <asp:GridView ID="grdCalculationDay" runat="server" AutoGenerateColumns="False" SkinID="grdNoFooter"
                                                            CssClass="mGrid">
                                                            <Columns>
