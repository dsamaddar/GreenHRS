...
Partial Class EmployeeProfile_frmEmpAcceptResignationReq
    Inherits System.Web.UI.Page

    Dim ResignationData As New clsResignationDataAccess()
    Dim EmployeeData As New clsEmpBasicProfileDataAccess()

    Protected Sub ShowSubmittedResignation(ByVal EmployeeID As String)
        grdSubmittedResignation.DataSource = ResignationData.fnGetSubmittedResigByEmpID(EmployeeID)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            ShowSubmittedResignation(EmployeeID)
