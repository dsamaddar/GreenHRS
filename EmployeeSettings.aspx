<%@ Page Language="VB" MasterPageFile="~/HRMMaster.master" AutoEventWireup="false"
    CodeFile="EmployeeSettings.aspx.vb" Inherits="EmployeeSettings" Title=":Employee Settings:"
    Theme="CommonSkin" %>
                ...
                <asp:Panel ID="pnlLateAttendanceCause" runat="server" Width="100%" SkinID="pnlInner">
                    <table style="width: 100%;">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:DropDownList ID="drpAvailableCause" runat="server" CssClass="InputTxtBox" Width="200px">
                                </asp:DropDownList>
                            </td>
                            <td>
                            </td>
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:CheckBox ID="chkIsDetailsMandatory" runat="server" CssClass="chkText" Text=" Is Mandatory"
                                    AutoPostBack="True" />
                            </td>
                            <td>
                            </td>
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:CheckBox ID="chkIsReportable" runat="server" AutoPostBack="True" CssClass="chkText"
                                    Text=" Is Reportable" />
                            </td>
                            <td>
                            </td>
