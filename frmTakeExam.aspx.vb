...
Partial Class frmTakeExam
    ...
    Protected Sub GetAvailableExamsForUser(ByVal UserID As String)
        drpAvailableQuestionForTheUser.DataTextField = "ExamName"
        drpAvailableQuestionForTheUser.DataValueField = "ExamID"
        drpAvailableQuestionForTheUser.DataSource = QuestionPaperData.fnGetAvailableExamsByUserID(UserID)
    ...
    Protected Sub timerControl_Tick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Convert.ToInt16(Session("Timer")) <= 0 Then
            ...
            Else
                ...
                lblMessageInfo.Text = "Time Out. Thanks For Participation."
                ClearTimeoutWindow()
            End If
